...
namespace AmharicDateConverter
{
    ...
    public class DateHelper
    {
        ...
        public DateHelper(string ddMMyyyy)
        {
        ...
        /// </summary>
        public DateHelper StartOfFiscalYear
        {
            get { return new DateHelper(((Month > 10) ? Year : Year - 1), 11, 1); }
        }

        /// <summary>
        /// Gets the end of fiscal year.
        /// </summary>
        public DateHelper EndOfFiscalYear
        {
            get { return new DateHelper((Month > 10) ? Year + 1 : Year, 10, 30); }
        }
